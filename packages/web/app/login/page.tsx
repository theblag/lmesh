  ...
  return (
    <ThemeProvider>
      ...
      <div className="w-full min-h-screen bg-(--background) text-(--foreground) grid grid-cols-1 md:grid-cols-12 overflow-x-hidden font-sans selection:bg-(--selection-bg) selection:text-(--selection-fg) transition-colors duration-200">
        ...
        <div className="hidden md:flex md:col-span-5 relative bg-(--card-bg) border-l border-(--border-color) flex-col justify-between p-8 overflow-hidden min-h-screen select-none">
          ...
          <div className="z-10 text-center space-y-1.5 max-w-sm mx-auto p-4 rounded-2xl bg-black/40 backdrop-blur-md border border-white/10 text-white shadow-lg">
